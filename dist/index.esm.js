import a$6, { createContext, forwardRef, useContext, useMemo, useCallback, useState, useRef, useEffect } from 'react';
...
setLocalSelectedRows, onRowSelectionChange) => {
    ...
    const handleSelectAllRows = useCallback((e) => {
    ...
    const handleRowSelection = useCallback((e, rowIndex) => {
...
const useTableSorting = (sort, onSortChange) => {
    const handleSortChange = useCallback((name) => {
...
const useExpandableRows = () => {
    ...
    const toggleExpandRow = useCallback((rowIndex) => {
